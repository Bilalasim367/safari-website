...
import { PerfumeUploadSchema, type PerfumeFormValues } from '@/lib/validations/product'
...
const DEFAULT_VARIANTS = [
  { size: '30ml', price: 0, sku: '', stock: 0 },
  { size: '50ml', price: 0, sku: '', stock: 0 },
  { size: '100ml', price: 0, sku: '', stock: 0 },
]

const defaultValues: PerfumeFormValues = {
  name: '',
  description: '',
  fragranceFamily: '',
  concentration: 'EDP',
...
export default function PerfumeUploadForm() {
  const router = useRouter()

  const form = useForm<PerfumeFormValues>({
    resolver: zodResolver(PerfumeUploadSchema),
    defaultValues,
  })
  ...
  async function onSubmit(data: PerfumeFormValues) {
    setSaving(true)
    try {
      const result = await createProduct({
        ...
        sizesAvailable: '30ml,50ml,100ml',
      ...
      if (result.success) {
        toast.success('Perfume product created')
      ...
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <div className="flex items-start justify-between gap-4 mb-6">
          <div>
            ...
            <h1 className="text-3xl font-serif font-bold">Create Perfume Product</h1>
            <p className="text-sm text-muted-foreground mt-1">Fill in the perfume details below</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
          <div className="lg:col-span-2 space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input {...field} placeholder="e.g. Safari Midnight" /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Textarea {...field} rows={4} placeholder="A bold and mysterious fragrance..." /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Select value={field.value || ''} onValueChange={field.onChange}>
                            <SelectTrigger className="w-full"><SelectValue placeholder="Select longevity" /></SelectTrigger>
                            <SelectContent>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Select value={field.value || ''} onValueChange={field.onChange}>
                            <SelectTrigger className="w-full"><SelectValue placeholder="Select sillage" /></SelectTrigger>
                            <SelectContent>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-xs text-muted-foreground mb-4">Default perfume sizes — 30ml, 50ml, and 100ml</p>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="e.g. PRF-30ML-001" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
            ...
            <Card>
              ...
              <CardContent>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Bottle / Spray Type *</FormLabel>
                      <FormControl>
                        <Select value={field.value} onValueChange={field.onChange}>
                          <SelectTrigger className="w-full"><SelectValue placeholder="Select bottle style" /></SelectTrigger>
                          <SelectContent>
                            <SelectItem value="spray">Spray</SelectItem>
                            <SelectItem value="atomizer">Atomizer</SelectItem>
                      ...
                      <FormControl>
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex flex-col gap-2">
                            <Button type="button" variant="outline" size="sm" disabled={uploadingImage} onClick={() => document.getElementById('perfume-main-image-upload')?.click()}>
                              {uploadingImage ? 'Uploading...' : 'Choose Image'}
                            </Button>
                            <input id="perfume-main-image-upload" type="file" accept="image/*" className="hidden" onChange={handleMainImageUpload} />
                            {field.value && (
