      ...
      <section className="section-padding bg-background">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-primary uppercase tracking-wider text-sm mb-4">The Beginning</p>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="text-center p-8">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4">Passion</h3>
              <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:order-1">
              <p className="text-primary uppercase tracking-wider text-sm mb-4">Our Process</p>
              <h2 className="text-3xl md:text-4xl font-semibold text-foreground mb-6">
                The Art of Creation
              </h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
