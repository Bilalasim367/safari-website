        ...
        <div className="container-custom max-w-4xl">
          <div className="space-y-10">
            ...
            <Card className="p-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>For questions about these Terms of Service, please contact us at legal@safari-perfumes.com or write to Safari Perfumes, Online store — nationwide delivery across Pakistan, No physical storefront.</p>
