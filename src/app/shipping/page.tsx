    ...
    <>
      <section className='relative h-[40vh] flex items-center justify-center overflow-hidden'>
        ...
        <div className='relative z-10 text-center'>
          <h1 className='text-4xl md:text-6xl font-semibold text-primary-foreground mb-4'>Shipping & Delivery</h1>
          <p className='text-muted-foreground text-lg'>
            <Link href='/' className='hover:text-foreground transition-colors'>Home</Link> / Shipping
          </p>
        </div>
      </section>
      ...
      <section className='section-padding bg-background'>
        <div className='container-custom'>
          <div className='max-w-4xl mx-auto'>
              ...
              <div className='space-y-4'>
                {[
                  ...
                  <div key={i} className='bg-card rounded-xl p-6 flex flex-wrap items-center justify-between gap-4 border border-border'>
                    <div>
                      <h3 className='text-foreground font-semibold'>{option.method}</h3>
                      <p className='text-muted-foreground text-sm'>{option.time}</p>
                    </div>
                    <div className='text-right'>
                      <span className='text-primary font-semibold text-lg'>{option.price}</span>
                      <p className='text-muted-foreground/60 text-sm'>{option.note}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <Card className='p-8 md:p-12 mb-12'>
              <h2 className='text-2xl font-semibold text-foreground mb-6'>Delivery Information</h2>
              <div className='space-y-6'>
                <div className='flex gap-4'>
                  ...
                  <div>
                    <h3 className='text-foreground font-semibold mb-1'>Secure Packaging</h3>
                    <p className='text-muted-foreground text-sm'>Every fragrance is carefully wrapped and sealed to ensure it arrives in perfect condition.</p>
                  </div>
                </div>
                <div className='flex gap-4'>
                  <div className='w-10 h-10 bg-primary/20 rounded-full flex items-center justify-center flex-shrink-0'>
                  ...
                  <div>
                    <h3 className='text-foreground font-semibold mb-1'>Tracking Included</h3>
                    <p className='text-muted-foreground text-sm'>All orders include real-time tracking so you can follow your package every step of the way.</p>
                  </div>
                </div>
                <div className='flex gap-4'>
                  <div className='w-10 h-10 bg-primary/20 rounded-full flex items-center justify-center flex-shrink-0'>
                  ...
                  <div>
                    <h3 className='text-foreground font-semibold mb-1'>Weekend Delivery</h3>
                    <p className='text-muted-foreground text-sm'>Express and Next Day options include Saturday delivery in select areas.</p>
                  </div>
                </div>
              </div>
            </Card>
